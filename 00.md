...
```json
{
  ...
  "content": "v1:SGVsbG8xMjM0NTY3ODlhYmNkZWY...",
  "tags": [
...
**Required fields:**
- **`content`**: TLS-serialized `KeyPackageBundle` from your MLS implementation, encoded in one of two formats:
  ...
  - **Legacy (hex)**: No prefix, hex-encoded content. This format is supported for backward compatibility but SHOULD NOT be used for new KeyPackages.
